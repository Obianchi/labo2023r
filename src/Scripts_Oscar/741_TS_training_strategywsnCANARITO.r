...
PARAM <- list()
PARAM$experimento <- "TS7410wsnCANARITO"

PARAM$exp_input <- "FE7310wsnCANARITO"
...
PARAM$train$undersampling <- 0.7

PARAM$train$semilla <- 829093 # cambiar por su propia semilla  !!!
