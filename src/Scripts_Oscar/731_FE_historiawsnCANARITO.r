...
PARAM <- list()
PARAM$experimento <- "FE7310wsnCANARITO"

PARAM$exp_input <- "DR7210wsn"
...
PARAM$RandomForest$semilla <- 829093 # cambiar por la propia semilla


# varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$ratio <- 1.0
# desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$desvios <- 7.0
# cambiar por la propia semilla
PARAM$CanaritosAsesinos$semilla <- 829069
